        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('wisatas.index') }}" :active="request()->routeIs('wisatas.index')">
                        {{ __('Wisata') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('kuliners.index') }}"
                        :active="request()->routeIs('kuliners.index')">
                        {{ __('Kuliner') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('penginapans.index') }}"
                        :active="request()->routeIs('penginapans.index')">
                        {{ __('Penginapan') }}
                    </x-jet-nav-link>
