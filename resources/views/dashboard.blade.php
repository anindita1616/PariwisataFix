        ...
        <div class="container">
            <section id="dispar-event" class="my-6 py-6">
                <div class="has-text-centered mb-5">
                    ...
                    <p class="subtitle is-size-5 has-text-grey">Bermacam Kegiatan yang akan di adakan kota balikpapan
                    </p>
                </div>
                    ...
                    <a href="/eventDetail" class="column is-3 item-event">
                        <figure>
                            ...
                            <figcaption>
                                ...
                                <p class="has-text-weight-bold mb-2 is-size-5">Pemilihan Duta Wisata Manuntung
                                    Balikpapan
                                    2021
                                </p>
                                <p class="has-text-light is-size-6">
                    ...
                    <a href="/artikelDetail" class="column is-4 item-artikel">
                        <figure>
                            ...
                            <figcaption>
                                ...
                                <p class="has-text-weight-bold is-size-4 has-text-grey-dark">Ini alasan mengapa kamu
                                    harus
                                    mengunjungi pantai lamaru</p>
                                ...
                                <p class="has-text-grey">Masyarakat kota balikpakan pasti sudah tidak asing dengan yang
                                    namanya
                                    wisata pantai lamaru, terlepas dari populernya wisata pantai lamaru memang pantas
                                    dan
                                    wajib
                                    untuk kamu kunjungi sebagai tamu kota balikpapan</p>
                            </figcaption>
                        </figure>
                    </a>
                    <a href="/artikelDetail" class="column is-4 item-artikel">
                        <figure>
                            ...
                            <figcaption>
                                <!-- <span class="tag is-link">Wisata</span> -->
                                <p class="has-text-weight-bold is-size-4 has-text-grey-dark">Beberapa spot wisata yang
                                    instagramable </p>
                                <p class="has-text-link has-text-weight-semibold mb-2 mt-1">
                                    <span class="icon">
                                        <i class="far fa-clock"></i>
                                ...
                                <p class="has-text-grey">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                    Exercitationem
                                    libero voluptas ea cum nesciunt aperiam esse maxime necessitatibus quis sit,
                                    corporis,
                                    voluptate dolore incidunt. Natus ducimus voluptatem laudantium ipsum assumenda.</p>
                            </figcaption>
                        </figure>
                    </a>
                    <a href="/artikelDetail" class="column is-4 item-artikel">
                        <figure>
                            ...
                            <figcaption>
                                <!-- <span class="tag is-link">Wisata</span> -->
                                <p class="has-text-weight-bold is-size-4 has-text-grey-dark">Waterboom menjadi langganan
                                    masyarakat kala liburan</p>
                                <p class="has-text-link has-text-weight-semibold mb-2 mt-1">
                                    <span class="icon">
                                        <i class="far fa-clock"></i>
                                    </span>
                                ...
                                <p class="has-text-grey">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ullam
                                    corrupti harum excepturi accusamus eos inventore ipsa ut sint, impedit nemo, maiores
                                    mollitia laboriosam fuga quasi provident necessitatibus molestiae itaque ex.</p>
                            </figcaption>
                        </figure>
                    </a>
                </div>
