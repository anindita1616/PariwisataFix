                ...
                <a href="/eventDetail" class="column is-3 item-event">
                    <figure>
                        ...
                        <figcaption>
                            ...
                            <p class="has-text-weight-bold mb-2 is-size-5">Pemilihan Duta Wisata Manuntung Balikpapan 2021
                            </p>
                            <p class="has-text-light is-size-6">
                                <span class="icon has-text-link">
                                    <i class="fas fa-map-marker-alt"></i>
                ...
                <a href="/artikelDetail" class="column is-4 item-artikel">
                    <figure>
                        ...
                        <figcaption>
                            ...
                            <p class="has-text-weight-bold is-size-4 has-text-grey-dark">Ini alasan mengapa kamu harus
                            ...
                            <p class="has-text-grey">Masyarakat kota balikpakan pasti sudah tidak asing dengan yang namanya
                                wisata pantai lamaru, terlepas dari populernya wisata pantai lamaru memang pantas dan wajib
                ...
                <a href="/artikelDetail" class="column is-4 item-artikel">
                    <figure>
                        ...
                        <figcaption>
                            ...
                            <p class="has-text-grey">Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem
                                libero voluptas ea cum nesciunt aperiam esse maxime necessitatibus quis sit, corporis,
