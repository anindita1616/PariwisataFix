            ...
            <section id="dispar-all-detail" class="my-6">
                <div class="columns is-centered is-multiline">
                    <div class="column is-7">
                        <iframe src="{{ $event->link }}" width="100%" height="300" style="border:0;"
                            allowfullscreen="" loading="lazy"></iframe>
                        <br>
                        <p class="is-size-3 has-text-weight-bold">{{ $event->nama }}</p>
                        <p class="is-size-5">{{ $event->alamat }}</p>
                        <div class="content">
                            <p class="has-text-grey">{{ $event->deskripsi }}</p>
                        </div>
                        <div>
